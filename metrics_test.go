...
compact         5     6 B     7 B       2          (size == estimated-debt, score = in-progress-bytes, in = num-in-progress)
  ctype        27      28      29      30      31      32      33  (default, delete, elision, move, read, rewrite, multiInput)
 memtbl        12    11 B
zmemtbl        14    13 B
   ztbl        16    15 B
...
compact         0     0 B     0 B       0          (size == estimated-debt, score = in-progress-bytes, in = num-in-progress)
  ctype         0       0       0       0       0       0       0  (default, delete, elision, move, read, rewrite, multiInput)
 memtbl         0     0 B
zmemtbl         0     0 B
   ztbl         0     0 B
